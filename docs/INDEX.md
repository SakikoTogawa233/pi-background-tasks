...
| --- | --- | --- | --- |
| command | `bg` | `command:bg` | `src/extension.ts:585` |
| command | `bg-clear` | `command:bg-clear` | `src/extension.ts:627` |
| command | `bg-tasks` | `command:bg-tasks` | `src/extension.ts:619` |
| command | `bg-update` | `command:bg-update` | `src/extension.ts:635` |
...
| command | `jobs` | `command:jobs` | `src/extension.ts:673` |
| command | `kill` | `command:kill` | `src/extension.ts:717` |
| command | `logs` | `command:logs` | `src/extension.ts:686` |
| command | `tasks` | `command:tasks` | `src/extension.ts:611` |
| tool | `bash` | `tool:bash` | `src/core/foreground-bash.ts:611` |
| tool | `bg_delegate` | `tool:bg_delegate` | `src/delegate-extension.ts:340` |
| tool | `bg_kill` | `tool:bg_kill` | `src/extension.ts:975` |
| tool | `bg_logs` | `tool:bg_logs` | `src/extension.ts:930` |
| tool | `bg_result` | `tool:bg_result` | `src/delegate-extension.ts:516` |
| tool | `bg_run` | `tool:bg_run` | `src/extension.ts:750` |
| tool | `bg_run_pi_attested` | `tool:bg_run_pi_attested` | `src/extension.ts:834` |
| tool | `bg_status` | `tool:bg_status` | `src/extension.ts:899` |
...
| shortcut | `ctrl+alt+c` | `shortcut:ctrl+alt+c` | `src/extension.ts:665` |
| shortcut | `ctrl+b` | `shortcut:ctrl+b` | `src/core/foreground-bash.ts:641` |
| shortcut | `shift+down` | `shortcut:shift+down` | `src/extension.ts:658` |
| renderer | `background-task-notification` | `renderer:background-task-notification` | `src/extension.ts:467` |
